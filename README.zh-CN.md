...
> 当前版本：[`v1.1.0`](https://github.com/hc938456/ah-disclosure-kit/releases/tag/v1.1.0)
>
...
显式传入 `-SkillInstallRoot` 可同时兼容 `v1.1.0` Release 资产和当前 `main` 分支；当前 `main` 的默认目录也已改为 `%USERPROFILE%\.agents\skills`。
